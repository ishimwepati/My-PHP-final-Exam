...
if(isset($_POST['btn-send']))
{
	...
	if($row['last_name']==($last_name))
	{
		...
		header("Location: welogin.php");
	}
	else
	{
		?>
        <script>alert('Sorry your details are incorrect !!!');</script>
        <?php
	}
    ...
    <td height="146" rowspan="2"><form id="form1" name="form1" method="post" action=""><table width="356" border="0" align="center">
      <tr>
        <td colspan="2"><div align="center">
          <h3>Don't worry your account is active! </h3>
        </div></td>
        </tr>
      <tr>
        <td height="100" colspan="2"><div align="center"><img src="Arrow3.jpeg" width="150" height="120" alt="f" /></div></td>
        </tr>
      <tr>
        <td bgcolor="#006633">
          <label for="textfield"></label>
          <div align="right">
            <input type="text" name="email" id="textfield2"  placeholder="Your email" required="required"/>
          </div></td>
        <td bgcolor="#006633"><input type="text" name="last_name" id="textfield"  placeholder="Your last name" required="required"/></td>
        </tr>
      <tr>
        <td colspan="2"><div align="center">
          <input type="submit" name="btn-send" id="button" value="Send" />
        </div></td>
        </tr>
      <tr>
        <td width="175"><a href="forget.php">Go back</a></td>
