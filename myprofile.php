...
<body >
<table width="1142" height="530" border="0" align="center" bgcolor="#FFFFFF">
  <tr>
  ...
  <tr>
    ...
    <td height="21" colspan="3"><h3 align="center">Your Details Are here :</h3></td>
    <td height="21" colspan="2"><strong>Your Profile <?php echo $userRow['first_name']; ?></strong></td>
  ...
  <tr>
    <td colspan="3" rowspan="2"><table width="382" height="117" border="0" align="center">
     
     
      <tr>
        <td height="21">First name</td>
        <td colspan="2"><?php echo $userRow['first_name']; ?></td>
        <td><?php echo " <a href='Edit.php?do=edit&user_id=" . $user_id . "'> Edit </a> "; ?></td>
        <td>&nbsp;</td>
      </tr>
      <tr>
        <td height="21">Other name</td>
        <td colspan="2"><?php echo $userRow['last_name']; ?></td>
        <td><?php echo " <a href='Edit.php?do=edit&user_id=" . $user_id . "'> Edit </a> "; ?></td>
        <td>&nbsp;</td>
      </tr>
      <tr>
        <td width="122" height="21">E-mail</td>
        <td colspan="2"><?php echo $userRow['email']; ?></td>
        <td width="28"><?php echo " <a href='Edit.php?do=edit&user_id=" . $user_id . "'> Edit </a> "; ?></td>
        <td width="19">&nbsp;</td>
        </tr>
      <tr>
        <td height="21">Phone Number</td>
        <td width="26"><?php echo $userRow['code']; ?></td>
        <td width="165"><?php echo $userRow['phone']; ?></td>
        <td><?php echo " <a href='Edit.php?do=edit&user_id=" . $user_id . "'> Edit </a> "; ?></td>
        <td>&nbsp;</td>
        </tr>
      <tr>
        <td height="21">Nationality</td>
        <td colspan="2"><?php echo $userRow['nationality']; ?></td>
        <td><?php echo " <a href='Edit.php?do=edit&user_id=" . $user_id . "'> Edit </a> "; ?></td>
        <td>&nbsp;</td>
        </tr>
    </table></td>
  ...
  <tr>
    <td height="11">&nbsp;</td>
    <td width="240" rowspan="3"><img src="training/hig.jpg" width="242" height="188" alt="jd" /></td>
    <td width="275" rowspan="3"><img src="training/k,.jpg" width="275" height="191" alt="hj" /></td>
    <td width="264" rowspan="3"><img src="training/u.jpg" width="258" height="195" alt="h" /></td>
  </tr>
  <tr>
    <td height="135">&nbsp;</td>
