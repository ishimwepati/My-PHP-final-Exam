...
<table width="1147" height="526" border="0" align="center" bgcolor="#FFFFFF">
  ...
  <tr>
    <td colspan="3" rowspan="2"><h3 align="center"><u>USERS LIST</u></h3>
      <table width="657" height="76" border="0" align="center">
      <tr>
        <td width="57" height="23"><h4 align="left"><strong>Name</strong></h4></td>
        <td width="112"><h4 align="left"><strong>Others name</strong></h4></td>
        <td width="143"><h4 align="left">E-mail</h4></td>
...
?>
      <tr>
        ...
        <td width="72"><?php echo " <a href='Delete.php?user_id=" . $user_id . "'> Delete </a> "; ?></td>
      </tr>
      <?php
